...
**/
public class GetBooklinks implements PageProcessor {
     ...
     *
     * @Author:          郭航飞
     * @CreateDate:   2018/5/3 13:51
     **/
    private void processBookName(Page page) {
     ...
     *
     * @Author:          郭航飞
     * @CreateDate:   2018/5/3 14:07
     * @param
     * @return
    **/
    private void processBookPage(Page page) {
     ...
     *
     * @Author:          郭航飞
     * @CreateDate:   2018/5/3 14:09
    **/
    private void processCatalog(Page page) {
     ...
     *
     * @Author:          郭航飞
     * @CreateDate:   2018/5/3 14:13
    **/
    private void processDownBook(Page page) {
...
//            获得内容
    ...
    public static void main(String[] args) {
        ...
        //启动爬虫
        Spider.create(new GetBooklinks())
                //添加初始化的URL
