...
<head>
    ...
    <link href="${basePath}resource/assets/font-awesome/css/font-awesome.css" rel="stylesheet" />
    <!-- Custom styles -->
  ...
  <body>
   <div class="page-404">
    ...
    <h2>Aww Snap!</h2>
    <p>Something went wrong or that page doesn’t exist yet. <br><a href="${basePath}index.jsp">Return Home</a></p>
  </div>
