...
<html lang="en">
                      ...
                      <div class="row">
                          <div class="col-lg-6">
                              ...
                              <section class="panel">
                                  ...
                                  <div class="panel-body">
                                      <input name="tagsinput" id="tagsinput" class="tagsinput" value="Creative, 主页, Admin, Template, Theme, Bootstrap, Responsive, Retina, Minimal" />
                                  </div>
                              </section>
                          </div>
                          <div class="col-lg-6">
  ...
  <!-- container section end -->
    ...
    <!-- bootstrap-wysiwyg -->
    <script src="${basePath}resource/js/jquery.hotkeys.js"></script>
    <script src="${basePath}resource/js/bootstrap-wysiwyg.js"></script>
    <script src="${basePath}resource/js/bootstrap-wysiwyg-custom.js"></script>
    <!-- ck editor -->
    <script type="text/javascript" src="${basePath}resource/assets/ckeditor/ckeditor.js"></script>
    <!-- custom form component script for this page-->
    <script src="${basePath}resource/js/form-component.js"></script>
